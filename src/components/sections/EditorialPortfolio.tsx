    ...
    <section id="portfolio" className="py-24 px-6 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
        <div>
          ...
          <h2 className="font-serif text-3xl sm:text-5xl text-[#2c2520] font-normal tracking-tight">
            Intentional, Not Overwhelming.
          </h2>
        </div>
        <p className="text-[#5c4f44] max-w-md text-sm sm:text-base font-light">
      ...
      <div className="flex items-center gap-2.5 overflow-x-auto pb-4 mb-10 no-scrollbar">
        {categories.map((cat) => (
          <button
            ...
            className={`px-5 py-2.5 rounded-full text-xs font-semibold tracking-wide transition-all shrink-0 cursor-pointer ${
      ...
      <div className="mt-16 p-8 rounded-3xl bg-[#f5efe4] border border-[#ebd8c0] flex flex-col sm:flex-row items-center justify-between gap-6 shadow-xs">
        ...
        <button
          ...
          className="px-6 py-3 rounded-full bg-[#b88548] text-white text-xs font-bold uppercase tracking-wider hover:bg-[#a07136] transition-colors shrink-0 shadow-md cursor-pointer"
        >
